...
| `survey_max_pages` | 150 | The survey chunk size: a source at or under it surveys in one request; a larger source surveys in page windows of this size, merged before normalization |
