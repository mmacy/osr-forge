...
def test_jn1_pinned_baseline_over_the_committed_caches(tmp_path: Path):
    ...
    # PHASE 9 PLACEHOLDERS — do not uncomment until the committed JN1 truth
    # pass lands (doors, transitions, entrance, and explicit encounters: []
    # on every verified-empty area). The exact values bless then, alongside
    # the truth-key freeze that makes any *existing*-family movement above a
    # scorer bug by construction.
    # assert metrics.encounters.precision_denominator == ...
    # assert metrics.encounters.precision_matched == ...
    # assert metrics.encounters.precision == ...
    # assert metrics.doors.truth_doors == ...
    # assert metrics.doors.extracted_doors == ...
    # assert metrics.doors.true_positives == ...
    # assert metrics.doors.recall == ...
    # assert metrics.doors.precision == ...
    # assert metrics.doors.kind_accuracy == ...
    # assert metrics.doors.locked_accuracy == ...
    # assert metrics.transitions.asserted_dungeons == ...
    # assert metrics.transitions.truth_transitions == ...
    # assert metrics.transitions.extracted_transitions == ...
    # assert metrics.transitions.true_positives == ...
    # assert metrics.transitions.recall == ...
    # assert metrics.transitions.precision == ...
    # assert metrics.transitions.kind_accuracy == ...
    # assert metrics.entrances.asserted == ...
    # assert metrics.entrances.matched == ...
    # assert metrics.entrances.accuracy == ...
